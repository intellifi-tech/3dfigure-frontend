<template lang="html">
<div class="col-md-6">
	<apex-area-line-chart :AreaLineChartTitle="!isSales ? 'Sipariş Sayısı' : 'Satış'" AreaLineChartSubtitle="Günlük" :chartData="lineAreaChartSpline"/>
</div>
</template>
...
export default {
  ...
  created: async function() {
    var data = await DashboardService.getOrdersMonthly();
    var d = [];
    d.length = 12;
    d.fill(0);
    data.forEach(element => {
      ...
      const value = !this.isSales ? element.split("-")[1] : element.split("-")[2]
