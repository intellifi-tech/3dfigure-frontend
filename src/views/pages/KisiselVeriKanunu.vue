<template>
  ...
  <br>
      ...
      <p>Şirket yukarıda açıklanan amaçlarla kişisel veriler şu kişilerle paylaşabilir:</p>

      <ul style=" list-style: disc;" class="container">
        <li>Şirket faaliyetlerini ve iş süreçlerini devam ettirmek için hizmet sunan ilgili departmanlar ile,</li>
        <li>Şirket adına kişisel veri işleyen yurt içi ve/veya yurt dışı hizmet sağlayıcılar ile,</li>
      ...
      <p>Kişisel veri sahibi, Kanun’un 11.maddesi uyarınca Şirket’e başvurarak;</p>

      <ul style=" list-style: lower-latin;" class="container">
        ...
        <li>Kişisel verileri eksik veya yanlış işlenmişse, bunların düzeltilmesini isteme, KVKK’nın 7. maddesinde öngörülen şartlar çerç evesinde silinmesini veya yok edilmesini isteme,</li>
